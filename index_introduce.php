...
<head>
    ...
    <style>
        .container__introduce-list{
            border-collapse: collapse;
            margin: 25px 0;
            font-size: 0.9em;
            border-radius: 5px 5px 0 0;
            overflow: hidden;
            box-shadow: 0 0 20px rgab(0, 0, 0, 0. 15);
        }
        .container__introduce-list thead tr{
            background-color: #333;
            color: #fff;
        }
        .container__introduce-list thead tr th{
            font-size: 20px;
        }
        .container__introduce-list th,
        .container__introduce-list td{
            padding: 12px 15px;
        }
        .container__introduce-list tbody tr{
                border-bottom: 1px solid #ddd;
        }
        .container__introduce-list tbody tr:nth-of-type(even){
                background-color: #f3f3f3;
        }
        .container__introduce-list tbody tr:last-of-type{
            border-bottom: 2px solid #333;
        }
        .container__introduce-list tbody tr.active-row{
            font-weight: bold;
            color: #333;
        }
        </style>
