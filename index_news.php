        ...
        <div class="main" style=" padding: 50px;">
            <div class="app" style="display: flex;">
                <?php
                    ...
                    if (isset($_GET['ID'])) {
                        $ID = $_GET['ID'];
                        $sql = "SELECT * FROM tinmoi WHERE ID = {$ID}";
                ...
                <div class="main__content l-9 m-12 c-12">
                        <h1 class="main__content__title"><?php echo $result['titlenew']; ?></h1>
                        <img src="<?php echo $result['imagenew']; ?>" alt="" class="main__content__img">
                        <p class="sub-img"><i>Nguon: Google</i></p>
                        <hr>
                    <div class="main__content__calendar">
                        <i class="fa fa-calendar-alt"></i>
                        <p><?php echo $result['timenew'];  ?></p>
                    </div>
                    <p class="main__content__text"><?php echo $result['detailsnew'] ?>; </p>
                </div>
            </div>
            <div class="exchange">
                <div class="recomment">
                ...
                <div class="comment">
                    <form action="http://localhost/News/index_news.php?ID=<?php echo $ID;?>" method="POST">
